...
void texture_load_pixels (char *path, u8 **pixels_out, size_t *width_out,
                          size_t *height_out);
struct Texture texture_create_from_pixels (u8 *pixels, size_t width,
                                           size_t height);
...
struct Atlas atlas_create_from_texture (struct Texture texture,
                                        ivec2s sprite_size);
