...
static void
_size_callback (GLFWwindow *handle, int width, int height)
{
...
static void
_cursor_callback (GLFWwindow *handle, double xp, double yp)
{
...
static void
_key_callback (GLFWwindow *handle, int key, int scancode, int action, int mods)
{
  if (key < 0)
    {
      return;
...
static void
_mouse_callback (GLFWwindow *handle, int button, int action, int mods)
{
  if (button < 0)
    {
      return;
...
void
window_create (FWindow init, FWindow destroy, FWindow tick, FWindow update,
               FWindow render)
{
  window.init = init;
...
static void
button_array_tick (size_t n, struct Button *buttons)
{
...
static void
button_array_update (size_t n, struct Button *buttons)
{
  for (size_t i = 0; i < n; i++)
    {
...
void
mouse_set_grabbed (bool grabbed)
{
