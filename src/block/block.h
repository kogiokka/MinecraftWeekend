...
struct Block
{
  ...
  ivec2s (*get_texture_location) (struct World *world, ivec3s pos,
                                  enum Direction d);
  void (*get_mesh_information) (struct World *world, ivec3s pos,
                                enum Direction d, vec3s *offset_out,
                                vec3s *size_out, ivec2s *uv_offset_out,
                                ivec2s *uv_size_out);
