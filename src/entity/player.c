...
//         (struct Ray) { .origin = self->camera.position, .direction =
//         self->camera.direction }, reach, raycast_block_fn,
//         &self->look_block, &self->look_face);

//     // place/destroy blocks
//     if (self->has_look_block) {
//         if
//         (state.window->mouse.buttons[GLFW_MOUSE_BUTTON_LEFT].pressed_tick)
//         {
//             world_set_block(self->world, self->look_block, 0);
//         }

//         if
//         (state.window->mouse.buttons[GLFW_MOUSE_BUTTON_RIGHT].pressed_tick)
//         {
//             world_set_block(
//                 self->world,
//                 glms_ivec3_add(self->look_block,
//                 DIR2IVEC3S(self->look_face)), self->selected_block);
//         }
//     }
// }